...
function TeacherDonationPage() {
    ...
    const [name, school, message, supplies, teacher_id, recordRetrieved] = useOutletContext();
                ...
                : <div className='dashboardHeader'>
                    <Header size='huge' textAlign='center'>
                        <Header.Content>
                            ...
                            <Header.Subheader>Record not accessed</Header.Subheader>
                        </Header.Content>
                    </Header>
                    <Container textAlign='center'>
                        <Message size="big" color='olive' compact>Check that the id '{teacher_id}' is correct</Message>
                    </Container>
                </div>
            }
